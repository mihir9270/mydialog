...
export declare class OneSignal {
     ...
     */
    static handleNotificationReceived(): Observable<any>;
    /**
     * Callback to run when a notification is opened
     * @return {Observable<any>}
     */
    static handleNotificationOpened(): Observable<any>;
    /**
     *
     * @param settings
     */
    ...
    */
    static postNotification(notificationObj: OneSignalNotification): Promise<any>;
    /**
